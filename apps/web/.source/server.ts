...
import * as __fd_glob_2 from "../content/docs/compliance-model.mdx?collection=docs"
import * as __fd_glob_1 from "../content/docs/auditor-portal.mdx?collection=docs"
...
export const docs = await create.doc("docs", "content/docs", {"architecture.mdx": __fd_glob_0, "auditor-portal.mdx": __fd_glob_1, "compliance-model.mdx": __fd_glob_2, "getting-started.mdx": __fd_glob_3, "index.mdx": __fd_glob_4, "limitations-roadmap.mdx": __fd_glob_5, "smart-contracts.mdx": __fd_glob_6, });
